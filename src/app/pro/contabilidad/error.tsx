...
export default function FiscalError({ reset }: { reset: () => void }) {
  return <div className="card p-6" role="alert">
    ...
    <p className="mt-3 text-sm">Compruebe su conexión y revise los registros pendientes de confirmación fiscal: el IVA y las retenciones de los cobros en la ficha de cada paciente, y el IVA recuperable de los gastos históricos.</p>
