...
const ACREDITACION: Record<string, { texto: string; clase: string }> = {
  ...
  provisional: {
    texto: "Acreditación sin comprobar",
    clase: "text-warning-ink",
  },
...
export function EquipoPanel({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Como la agenda y la semana en «Hoy»: el equipo a la izquierda, a lo
          ancho, y lo que se hace con él —invitar, revocar— a la derecha. */}
      <div className="flex flex-col gap-8 lg:flex-row">
        <section className="flex min-w-0 flex-1 flex-col gap-3">
          ...
          <div className="overflow-x-auto">
            <table className="table-base table-plain">
              ...
              <tbody>
                {miembros.map((m) => {
                  const acred = m.verificacion
                    ? ACREDITACION[m.verificacion]
                    : null;
                          ...
                          {gestionable && (
                            <div className="flex flex-wrap items-center justify-end gap-x-4 gap-y-2">
                              ...
                              <button
                                ...
                                onClick={() =>
                                  run(() =>
                                    callAction(revocarMiembroAction, m.id)
                                  )
                                }
        ...
        {puedeGestionar && (
          <div className="flex w-full flex-col gap-7 lg:w-[400px] lg:shrink-0">
            {/* Sin caja: el formulario va sobre la hoja, como todo lo demás. */}
            <section className="flex flex-col gap-3.5">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    value={rol}
                    onChange={(e) =>
                      setRol(e.target.value as "admin" | "member")
                    }
                  >
              ...
              <p className="max-w-prose text-[12.5px] leading-relaxed text-ink-3">
                ...
                se reparte desde aquí. Quien ya tenga su acreditación aprobada
                no vuelve a pasar por revisión por unirse a este centro.
              </p>
